...
snake_body = [
    [xwindow / 2, ywindow / 2],
    [(xwindow / 2) - 20, (ywindow / 2) - 20],
    [(xwindow / 2) - 40, (ywindow / 2) - 40],
]
...
def show_start_screen():
    ...
    for i, text in enumerate(controls_text):
        ...
        controls_rect = controls_surface.get_rect(
            center=(xwindow / 2, ywindow / 2 + i * 40)
        )
...
def reset_game():
    ...
    fruit_pos = [
        random.randrange(25, (xwindow - 25)),
        random.randrange(25, (ywindow - 25)),
    ]
    fruit_spawn = True
    dir = "RIGHT"
    change = dir
...
while running:
    ...
    if not (20 < snake_pos[0] < (xwindow - 20)) or not (
        20 < snake_pos[1] < (ywindow - 20)
    ):
